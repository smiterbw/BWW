...
class CfgVehicles
{
    ...
    class bws_snow_assault: B_AssaultPack_rgr
	{
        ...
        picture = "\bws_backpacks\ui\snow_assault_icon.paa";
		hiddenSelectionsTextures[]={"\bws_backpacks\data\snow_assault.paa"};
	};
	class B_Kitbag_rgr;
    class bws_snow_kitbag: B_Kitbag_rgr
	{
        ...
        picture = "\bws_backpacks\ui\snow_kitbag_icon.paa";
		hiddenSelectionsTextures[]={"\bws_backpacks\data\snow_kitbag.paa"};
	};
    ...
    class bws_snow_carryall: B_Carryall_cbr
	{
        ...
        picture = "\bws_backpacks\ui\snow_carryall_icon.paa";
		hiddenSelectionsTextures[]={"\bws_backpacks\data\snow_carryall.paa"};
	};
    ...
    class bws_snow_viper: B_ViperHarness_blk_F
	{
        ...
        picture = "\bws_backpacks\ui\snow_viper_icon.paa";
		hiddenSelectionsTextures[]={"\bws_backpacks\data\snow_viper.paa"};
	};
    ...
    class bws_special_snow: B_Soldier_base_F
	{
		...
		picture = "\bws_uniforms\ui\viper_suit_snow_icon.paa";
		uniformClass = "bws_special_snow_u";
		hiddenSelections[] = {"camo","insignia"};
		hiddenSelectionsTextures[] = {"\bws_uniforms\data\viper_suit_snow.paa"};
	};
	// BLUFOR
    ...
    class bws_stealth_snow: O_Soldier_base_F
	{
		...
		picture = "\bws_uniforms\ui\stealth_uniform_snow_icon.paa";
		uniformClass = "bws_stealth_snow_u";
		hiddenSelections[] = {"camo","insignia"};
		hiddenSelectionsTextures[] = {"\bws_uniforms\data\stealth_uniform_snow.paa"};
	};
	// INDFOR
    ...
    class bws_combat_digital_snow: I_Soldier_base_F
	{
		...
		picture = "\bws_uniforms\ui\combat_digital_snow_icon.paa";
		uniformClass = "bws_combat_digital_snow_u";
		hiddenSelections[] = {"camo","insignia"};
		hiddenSelectionsTextures[] = {"\bws_uniforms\data\combat_digital_snow.paa"};
	};
    class bws_combat_digital_rolled_snow: I_Soldier_base_F
	{
		...
		picture = "\bws_uniforms\ui\combat_digital_rolled_snow_icon.paa";
		uniformClass = "bws_combat_digital_snow_u";
		hiddenSelections[] = {"camo","insignia"};
		hiddenSelectionsTextures[] = {"\bws_uniforms\data\combat_digital_snow.paa"};
	};
	...
	hiddenSelectionsTextures[]= {"\bws_vehicles\data\badger_snow.paa","\bws_vehicles\data\badger_under_snow.paa","\bws_vehicles\data\badger_turret_snow.paa"};
	};
	// Opfor
	...
	hiddenSelectionsTextures[]= {"\bws_vehicles\data\marid_snow.paa","\bws_vehicles\data\marid_under_snow.paa","\bws_vehicles\data\marid_turret_snow.paa"};
	};
	...
	hiddenSelectionsTextures[]= {"\bws_vehicles\data\marid_grey.paa","\bws_vehicles\data\marid_under_grey.paa","\bws_vehicles\data\marid_turret_grey.paa"};
	};
	...
	hiddenSelectionsTextures[]= {"\bws_vehicles\data\marid_digi.paa","\bws_vehicles\data\marid_under_digi.paa","\bws_vehicles\data\marid_turret_digi.paa"};
	};
	...
	hiddenSelectionsTextures[]= {"\bws_vehicles\data\kuma_grey.paa","\bws_vehicles\data\kuma_under_grey.paa","\bws_vehicles\data\kuma_turret_grey.paa"};
	};
};
...
class cfgWeapons
{
    ...
    class bws_viper_helmet_snow : H_HelmetO_ViperSP_ghex_F
    {
        ...
        picture = "\bws_helmets\ui\viper_helmet_snow_icon.paa";
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"\bws_helmets\data\viper_helmet_snow.paa"};
    };
	// STEALTH
    ...
    class bws_stealth_helmet_snow : H_HelmetB_TI_tna_F
    {
        ...
        picture = "\bws_helmets\ui\stealth_helmet_snow_icon.paa";
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"\bws_helmets\data\stealth_helmet_snow.paa"};
    };
	// BEANIE
	...
	class bws_beanie_snow : H_Watchcap_blk
    {
        ...
        picture = "\bws_helmets\ui\beanie_snow_icon.paa";
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"\bws_helmets\data\beanie_snow.paa"};
    };
	// COMBAT HELMET
	...
	class bws_combat_helmet_snow : H_HelmetB_plain_blk
    {
        ...
        picture = "\bws_helmets\ui\combat_helmet_snow_icon.paa";
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"\bws_helmets\data\combat_helmet_snow.paa"};
    };
    ...
    class bws_carrier_snow: V_PlateCarrier2_blk
    {
        ...
        picture = "\bws_vests\ui\carrier_snow_icon.paa";
		model = "\A3\Characters_F\BLUFOR\equip_b_vest01.p3d";
        hiddenSelectionsTextures[] = {"\bws_vests\data\carrier_snow.paa"};
    };
	// GL
    ...
    class bws_carrier_gl_snow: V_PlateCarrierGL_rgr
    {
        ...
        picture = "\bws_vests\ui\carrier_gl_snow_icon.paa";
        model = "\A3\Characters_F\BLUFOR\equip_b_carrier_gl_rig.p3d";
        hiddenSelectionsTextures[] = {"\bws_vests\data\carrier_spec_snow.paa"};
	};
	// SPECIAL
    ...
    class bws_carrier_spec_snow: V_PlateCarrierSpec_rgr
    {
        ...
        picture = "\bws_vests\ui\carrier_spec_snow_icon.paa";
	...
	class bws_ga_carrier_lite_snow: V_PlateCarrierIA1_dgtl
	{
		...
		picture = "\bws_vests\ui\ga_carrier_snow_lite_icon.paa";
		model = "\A3\Characters_F_beta\INDEP\equip_ia_vest01.p3d";
		hiddenSelectionsTextures[] = {"\bws_vests\data\ga_carrier_snow.paa"};
	};
	...
	class bws_ga_carrier_snow: V_PlateCarrierIA2_dgtl
	{
		...
		picture = "\bws_vests\ui\ga_carrier_snow_icon.paa";
